"""Check the archived manifest against committed Git blobs, without network access."""
import hashlib,json,subprocess
from pathlib import Path
root=Path(__file__).resolve().parents[1]
record=json.loads((root/'evidence/scalable-upgrade.json').read_text(encoding='utf8'))
